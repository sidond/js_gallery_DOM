...
const image1 = document.querySelector(
  'a > img[src^="/landscape-first-thumb"]',
)?.parentElement;

const image2 = document.querySelector(
  'a > img[src^="/landscape-second-thumb"]',
)?.parentElement;

const image3 = document.querySelector(
  'a > img[src^="/landscape-third-thumb"]',
)?.parentElement;

const image4 = document.querySelector(
  'a > img[src^="/landscape-fourth-thumb"]',
)?.parentElement;

const image5 = document.querySelector(
  'a > img[src^="/landscape-fifth-thumb"]',
)?.parentElement;
